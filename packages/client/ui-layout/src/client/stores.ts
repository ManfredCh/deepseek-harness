    ...
    actions: {
      ...
      openRightbar: (d, track: boolean, fullscreen: boolean, alongside = false) => {
        ...
        d.layoutInfo.rightbar ??= alongside
          ? Math.max(RIGHTBAR_MIN,d.layoutInfo.viewportWidth-(d.layoutInfo.viewportWidth<SIDEBAR_AUTO_COLLAPSE?SIDEBAR_COLLAPSED:(d.layoutInfo.sidebar||SIDEBAR_COLLAPSED))-400)
