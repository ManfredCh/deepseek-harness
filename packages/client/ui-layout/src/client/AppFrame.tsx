...
export function AppFrame({
  ...
  const stacked = Boolean(layoutInfo.rightbarAlongside && layoutInfo.rightbarTrack && !layoutInfo.rightbarFullscreen && viewport-measured.sidebar<900)
  const normal = stacked ? {...measured,center:Math.max(0,viewport-measured.sidebar),rightbar:Math.max(0,viewport-measured.sidebar)} : measured
