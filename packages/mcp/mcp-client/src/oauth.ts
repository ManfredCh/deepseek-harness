...
import type { OAuthClientProvider as SdkOAuthClientProvider, AuthResult } from '@modelcontextprotocol/sdk/client/auth.js'

export type { AuthResult, OAuthDiscoveryState } from '@modelcontextprotocol/sdk/client/auth.js'
export type OAuthClientProvider = SdkOAuthClientProvider & { forTransport?(): SdkOAuthClientProvider }
export type { OAuthClientMetadata, OAuthClientInformationMixed, OAuthTokens } from '@modelcontextprotocol/sdk/shared/auth.js'
