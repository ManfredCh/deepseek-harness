...
description: "Select the smallest tests and checks that cover an outgoing or just-published deepseek-harness diff, without reflexively running the full repository suite. Use before pushing, force-pushing, marking ready for review, or claiming checks pass, and immediately after gh stack sync publishes rewritten branches."
---
